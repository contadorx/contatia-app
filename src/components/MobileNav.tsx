...
export function MobileNav({ isSuperadmin = false, userLabel, roleLabel, unreadReplies = 0, triageCount = 0 }: { isSuperadmin?: boolean; userLabel?: string; roleLabel?: string; unreadReplies?: number; triageCount?: number }) {
