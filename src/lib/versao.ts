...
// ============================================================
export const VERSAO_APP = "2026.08.06-53";
...
export const VERSAO_NOTAS = "um clique drena a fila, sessao IMAP unica para Enviados, tempo medido por e-mail e o commit publicado no rodape";
