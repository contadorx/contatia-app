...
// ============================================================
export const VERSAO_APP = "2026.08.04-20";
...
export const VERSAO_NOTAS = "Brevo: 2xx e envio feito (corpo ilegivel nao e mais falha) · regua nao reenvia depois de falhar";
