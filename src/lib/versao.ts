...
// ============================================================
export const VERSAO_APP = "2026.08.05-45";
...
export const VERSAO_NOTAS = "e-mail embaixo do nome na lista de contatos, com o veredito (bate com o nome / caixa geral / outro nome)";
