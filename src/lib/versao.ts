...
// ============================================================
export const VERSAO_APP = "2026.08.03-6";
...
export const VERSAO_NOTAS = "busca no seletor de cadência · sócio herda dados da empresa · outros contatos da empresa · filtros preservados ao voltar";
