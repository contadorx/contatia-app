...
// ============================================================
export const VERSAO_APP = "2026.08.04-28";
...
export const VERSAO_NOTAS = "nenhum envio sai com [object Object]/undefined no texto — bloqueio no envio, nao so no render";
