...
// ============================================================
export const VERSAO_APP = "2026.08.04-24";
...
export const VERSAO_NOTAS = "bloco parava de procurar e-mail achando que ja tinha o do decisor: agora confere se o endereco e DA PESSOA";
