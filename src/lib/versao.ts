...
// ============================================================
export const VERSAO_APP = "2026.08.04-9";
...
export const VERSAO_NOTAS = "captura o link send/?phone= do Elementor · WhatsApp publicado substitui fixo · fixo nao recebe o 9o digito";
