...
// ============================================================
export const VERSAO_APP = "2026.08.04-29";
...
export const VERSAO_NOTAS = "uma leitura do site traz telefone, WhatsApp, e-mail, Instagram e LinkedIn juntos (eram tres varreduras com paginas diferentes)";
