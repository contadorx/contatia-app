...
// ============================================================
export const VERSAO_APP = "2026.08.04-3";
...
export const VERSAO_NOTAS = "domínio digitado à mão não é sobrescrito · aviso de domínio inexistente · e-mail descoberto já vem verificado · aberturas, cliques e hard bounce";
